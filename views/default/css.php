...
#layout_header {
	...
	width:100%;
	height:175px;
	background: url(<?php echo $vars['url']; ?>mod/theme_coldtrick/_graphics/header_bg.png) repeat-x top center;
}
#wrapper_header {
	height:175px;
	background: url(<?php echo $vars['url']; ?>mod/theme_coldtrick/_graphics/header.jpeg) no-repeat top center;
	text-align:center;
}
#wrapper_header h1 {
	padding:10px 0;
...
#wrapper_spotlight .collapsable_box_header h1, #wrapper_spotlight .collapsable_box_header a{
...
*************************************** */
#layout_footer {
	background: url(<?php echo $vars['url']; ?>mod/theme_coldtrick/_graphics/footer.png) repeat-x top left;
	height:140px;
	text-align: center;
...
*************************************** */
	...
	background:#525252 url(<?php echo $vars['url']; ?>mod/theme_coldtrick/_graphics/toolbar_messages_icon.gif) no-repeat left 0px;
	padding:0 0 0 12px;
	margin:0 15px 0 5px;
	cursor:pointer;
	font-size: 11px;
	...
	text-decoration: none;
	background:transparent url(<?php echo $vars['url']; ?>mod/theme_coldtrick/_graphics/toolbar_messages_icon.gif) no-repeat left -38px;
}
#elgg_topbar_container_left a.privatemessages_new {
	background: transparent url(<?php echo $vars['url']; ?>mod/theme_coldtrick/_graphics/toolbar_messages_icon.gif) no-repeat left -16px;
	padding:0 0 0 18px;
	margin:0 15px 0 5px;
	color: #525252;
}
...
ul.topbardropdownmenu ul li a {
	...
	background-color: #525252;/* menu off state color */
	color:#999999;
	font-weight: bold;
	padding-left:6px;
	padding-top:4px;
...
*************************************** */
.messages {
    background:#999999 url(<?php echo $vars['url']; ?>mod/theme_coldtrick/_graphics/ok.png) no-repeat 5px 30px;
    color:#FFFFFF;
    padding:28px 10px 3px 55px;
    font-size: 140%;
    z-index: 8000;
    width: 100%;
    top: 0px;
...
.messages_error {
    background:#999999 url(<?php echo $vars['url']; ?>mod/theme_coldtrick/_graphics/not_ok.png) no-repeat 5px 30px;
    color:#FFFFFF;
    padding:28px 10px 3px 55px;
    font-size: 140%;
    z-index: 8000;
...
/* groups */
#group_members h2, #right_column h2, #left_column h2, #fullcolumn h2  {
	color: #525252 !important;
}
...
/* draggable widgets */
a.toggle_customise_edit_panel_override {
	background: #FFFFFF !important;
	border:1px solid #999999 !important;
	color:#525252 !important;
}

a.toggle_customise_edit_panel_override:hover {
	color:#FFFFFF !important;
	background: #525252 !important;
...
#index_welcome #login-box h2, .index_box h2{
	color: #525252 !important;
}

/* river dashboard */
.river_pagination .forward, .river_pagination .back {
	color: #525252 !important;
}

.river_pagination .forward:hover, .river_pagination .back:hover {
	color: white !important;
	background: #525252 !important;
	border:1px solid #525252 !important;
}
